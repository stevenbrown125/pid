    ...
    <Layout>
      ...
      <div className="p-12 shadow-inner bg-neutral-200">
        <div className="mx-auto lg:max-w-5xl">
          <h4 className="flex items-center justify-center ml-4 text-3xl font-extrabold tracking-tight text-neutral-800 sm:text-4xl">
            <svg viewBox="0 0 495 495" className="w-1/4 mr-4 text-red-500">
              <polygon
                fill="currentColor"
            ...
            <span className="block w-full">Want more information?</span>
          </h4>
          <div
            className={`${
