  ...
  return (
    <Layout>
      ...
      <section className="bg-neutral-50">
        <div className="relative px-4 py-12 mx-auto bg-white shadow-md max-w-7xl sm:px-12 lg:px-16 md:px-6">
          <div className="text-base max-w-prose lg:max-w-none">
            <h2 className="font-semibold leading-6 tracking-wide text-red-600 uppercase">
              About Us
            </h2>
            <p className="mb-6 text-3xl font-extrabold leading-8 tracking-tight text-stone-800 sm:text-4xl">
              Home of the HNU
            </p>
          </div>
          <div className="w-full px-4 prose prose-lg lg:grid lg:grid-cols-2 lg:gap-6 md:max-w-none">
            <div className="prose-lg text-gray-500 lg:max-w-none">
              <p>
                PID Analyzers, LLC was formed in April 2003 to acquire the
                assets of HNU Systems. Inc. (developer of the first commercial
                photoionization instrumentation).
              </p>
              <p className="mt-4">
                More than 40,000 systems had been sold worldwide between
                1973-2003. We still service many of the older instruments such
                as the PI101, DL101, IS101, PI51, PI51…
              </p>
              <p className="mt-4">
                Our first goal was to develop multifunctional microprocessor
                based electronics that could be used with virtually any sensor
                technology for monitoring chemicals. This would be used to
                expand HNU&rsquo;s pioneering photoionization technology that
                was acquired. A second goal was to develop new and/or improved
                sensors that could be incorporated into our analyzers. We have
                achieved these goals with the introduction of the Model 102+.
                The amp board in this analyzer has 5 amplifiers in a compact
                board.
              </p>
            </div>
            <div className="mt-6 prose-lg text-gray-500 lg:mt-0">
              ...
              <p className="mt-4">
                All of our analyzers have proprietary software (operating
                systems) from the microcontrollers in the Model 102 to the 32
                bit C++ software in our embedded software for the Model 301C
                (PeakWorks™) that runs on Windows XP.
              </p>
            </div>
          </div>
        ...
        <div className="relative py-12 shadow-inner bg-neutral-200">
            ...
            <div className="relative max-w-md px-4 mx-auto sm:max-w-3xl sm:px-6 lg:px-0">
              ...
              <div className="pt-8">
                ...
                <div className="mt-6 space-y-6 text-gray-500">
                  <p className="text-lg">
                    We have worked with the US Navy since 1982 to provide
                    portable VOC Analyzers (HNU Model 101, spare parts and
                    service. Now we provide the PID Model 102 VOC Analyzers to
                    the Navy Undersea Systems for all submarines in the US
                    fleet.
                  </p>
                  <p className="text-base leading-7">
                    Our Model 102 has been third party tested and is listed on
