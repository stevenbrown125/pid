  ...
  return (
    <Layout>
      <Seo
        ...
        description="This Privacy Policy describes Our policies and procedures on the
          collection, use and disclosure of Your information when You use the
          Service and tells You about Your privacy rights and how the law
          protects You."
      />
      <section className="p-16 mx-auto prose bg-white shadow-md max-w-7xl lg:prose-lg">
        <h1>PID Analyzers, LLC - Privacy Policy</h1>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to PID Analyzers, LLC, 2 Washington
              Circle, Unit 4 Sandwich MA, 02563.
            </p>
            <p>
          ...
          <li>
            <p>
              ...
              <a
                ...
                target="_blank"
              >
                https://www.facebook.com/pidanalyzers
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              <a
                className="px-1 text-red-600 hover:text-red-800"
                href="https://www.hnu.com/privacy-policy"
                rel="external nofollow noopener noreferrer"
                target="_blank"
              >
                https://www.hnu.com/privacy-policy
              </a>
            </p>
          </li>
        </ul>
