        ...
        <div className="w-full px-4 pb-20">
          <div className="w-full max-w-5xl p-2 mx-auto bg-white rounded-2xl">
            {renderFaq.length === 0 ? (
              ...
              renderFaq.map((faq, i) => (
                <Disclosure as="div" className="mt-2" key={`faq-${i}`}>
                  {({ open }) => (
                    <>
                      <Disclosure.Button className="flex justify-between w-full px-4 py-2 text-sm font-medium text-left text-white bg-red-900 rounded-lg sm:text-md md:text-lg focus:outline-none hover:bg-red-600 focus-visible:ring focus-visible:ring-red-500 focus-visible:ring-opacity-75">
