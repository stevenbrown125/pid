    ...
    <Layout>
      ...
      <section className="relative px-4 py-6 pb-10 mx-auto shadow-md sm:px-12 lg:px-16 lg:max-w-7xl ">
        <div className="text-base">
          ...
          <h4 className="text-2xl font-bold text-red-800 text-md ">
        ...
        <div className="prose text-gray-500 lg:prose-lg max-w-none">
          ...
          <p>
            <span className="font-semibold">Chemical Name:</span> Aluminum Oxide
          </p>
          <p>
          ...
          <p>
            <span className="font-semibold">LD50 or LC50Route / Species:</span>{' '}
            N/A
          </p>
          ...
          <p>
            ...
            individuals in such atmospheres have no real chance of asphyxiation.
          </p>
          ...
          <p>
            ...
            Ingestion unlikely, CALL DOCTOR IMMEDIATELY. Do not induce vomiting.
          </p>
          <p>
          ...
          <p>
            <span className="font-semibold uppercase">Eyes:</span> WASH EYES IN
            EYEWASH FOR 30 MINUTES LET DRIP DRY. DO NOT RUB EYES
          </p>
          <p>
            <span className="font-semibold uppercase">Ingestion:</span> DO NOT
            INGEST. PROMPT MEDICAL ATTENTION IS MANDATORY IN ALL CASED OF
            OVEREXPOSURE. RESCUE PERSONNEL SHOULD BE EQUIPPED WITH POISON KITS.
            Victims should be assisted to an uncontaminated area and inhale
            fresh air. Quick removal from the contaminated area is most
          ...
          <p>
            n terms of weight, these containers hold very little contents, such
            that any accidental release by puncturing etc. will be of no
            practical concern.
          </p>
          ...
          <p>
            ...
            cylinder by any means to increase rate of product from the cylinder.
            Do not allow the temperature where syringes are stored to exceed
            130oF (54oC).
          </p>
          ...
          <p>Stable under normal conditions. Expected shelf life 24 months.</p>
          ...
          <p>
            ...
            section 112(r) of the Clean Air Act (CAA) with a threshold quantity
            (TQ) of 10,000 pounds.
          </p>
          ...
          <p>
            This MSDS has been prepared in accordance with the Chemicals (Hazard
            Information and Packaging for Supply (Amendment) Regulation 1996.
            The information is based on the best knowledge of PID Analyzers, LLC
            , and its advisors and is given in good faith, but we cannot
            guarantee its accuracy, reliability or completeness and therefore
            disclaim any liability for loss or damage arising out of use of this
            data. Since conditions of use are outside the control of the Company
            and its advisors we disclaim any liability for loss or damage when
            the product is used for other purposes than it is intended.
            MSDS/81-101-500/March, 2006
          </p>
        </div>
      </section>
      <CTA />
