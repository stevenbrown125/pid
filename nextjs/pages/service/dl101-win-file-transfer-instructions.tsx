...
const DL101WinFileXferInstructionsPage: NextPage = () => {
  return (
    <Layout>
      <Seo title="DL101 Windows File Transfer Instructions" />
      <section className="relative px-4 py-6 pb-10 mx-auto shadow-md sm:px-12 lg:px-16 lg:max-w-7xl ">
        <div className="text-base">
          ...
          <h3 className="text-3xl font-extrabold leading-8 tracking-tight text-stone-800 sm:text-4xl">
            DL101 Windows&reg; File Transfer Instructions
          </h3>
        ...
        <div className="prose text-gray-500 lg:prose-lg max-w-none">
          <p>
            ...
            established between the DL-101 and the PC. Select the telephone icon
            on the top of the HyperTerminal toolbar to establish a connection
            (indicated in the lower left of the screen
          ...
          <ul>
            <li>
              Connect Using: <span className="font-bold">Direct to Com 1</span>{' '}
              (all other entry fields should be gray)
            </li>
            <li>
            ...
            <ul>
              ...
              <li>
                ...
                <span className="font-bold">Advanced Port Settings</span> screen
              </li>
            </ul>
            <li>
                ...
                <li>
                  ...
                  <ul>
                    <li>
                      ...
                      <ul>
                        <li>
                          The ASCII Sending is for transmitting data from the PC
                          and is not used for DL-101 communication; leave all of
          ...
          <p>
            The PC is now correctly configured to receive data from the DL-101.
            Now that the PC has been correctly configured, saving these settings
            will make it quick and easy to transfer data in the future. To save
            the settings, select File, Save As, and enter a file name that is
            easy to identify (i.e. dl_win95.ht). Refer to the DL-101 operating
            manual for additional information related to the DL-101.
          </p>
        </div>
      </section>
      <CTA />
