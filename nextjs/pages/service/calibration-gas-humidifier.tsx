        ...
        <div className="relative px-4 pt-4 mx-auto bg-white shadow-md sm:px-12 lg:px-16 lg:max-w-7xl">
          ...
          <div className="prose text-gray-500 md:prose-lg max-w-none">
            ...
            <p>
              ...
              conditions (see graph below). A decrease in response with
              increasing humidity results from absorption of the light energy by
              the water (in the 125-105 nm region). The experienced user
              compensates for these effects by calibrating the unit with
              standards prepared at ambient humidity levels. While not
              particularly difficult this can become a cumbersome and time
              consuming procedure.
            </p>
            ...
            <p>
              ...
              device for calibrating our photoionization based analyzers (PI,
              IS, 102) at ambient humidity conditions. This simple is called a
              ...
              and the probe of the PID analyzer. Once in place, the standard
              Model 101 calibration procedure is follow (see below). The
              membrane “instantaneously” equilibrates the calibration gas to
              ambient humidity conditions. As a result, ambient humidity effects
              are eliminated. The calibration gas humidifier lets you read
              directly in ppm with virtually no inaccuracies-even in high
              humidity conditions.
            </p>
          </div>
          ...
          <div className="prose text-gray-500 border-t md:prose-lg max-w-none border-neutral-500">
            ...
            <ol>
              ...
              <li>
                Connect the fitting and (white polypropylene) of the humidifier
                to the 101 probe extension.
              </li>
              <li>Open the valve on the span gas cylinder.</li>
              <li>
                When the reading stabilizes (15-30 seconds), adjust the Span Pot
                until the meter reads the correct value for the calibration gas
                in use. For a benzene-referred calibration using Process
                Analyzers span gas, adjust the meter to read the value on the
                cylinder label (normally about 55 oom).
              </li>
              <li>
            ...
            <p>
              NOTE: These procedures must be followed using our membrane device
              to provide correlative data between PID and FID analyzers for soil
          ...
          <div className="flex justify-center py-6 pb-16 mr-4 md:justify-start ">
            <Link href="/contact">
