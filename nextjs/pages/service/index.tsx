...
const ServicePage: NextPage = () => {
  return (
    <Layout>
      ...
      />
      <section>
        <div className="relative px-4 pt-4 mx-auto bg-white shadow-md md:pt-8 sm:px-12 lg:px-16 lg:max-w-7xl">
          <div className="grid md:grid-cols-12">
            {/* Service Links */}

            {/* Main Content */}
            <div className="relative pb-6 md:col-span-9 md:bg-white md:p-6">
              <h2 className="font-semibold leading-6 tracking-wide text-red-600 uppercase">
                System Service
              </h2>
              <h3 className="mb-6 text-2xl font-extrabold leading-8 tracking-tight text-neutral-600 sm:text-4xl">
              ...
              <div className="lg:grid lg:grid-cols-1 lg:gap-6">
                <div className="prose prose-lg text-neutral-600 prose-primary lg:max-w-none">
                  ...
                  <p className="mt-4">
                    If you are sending in your unit for cleaning and
                    calibration, please look at our RA Checklist to make sure
                    that you include all components needed to diagnose and
                    repair your instruments. If you have any questions regarding
                    packaging and shipping address you will find this
                    information there. Likewise, you may fill out our online
                    return authorization form for fastest service.
                  </p>
                  <p className="mt-4">
                    When we recieve your instrument, we will fax to you a repair
                    estimate. No work will be performed until this repair
                    estimate has been approved by you. If the repair estimate is
                    declined we will charge a one time evaluation fee of $95.
                  </p>
                  <p className="mt-4">
                    For information regarding service for your HNU, contact the
                    service department at service@hnu.com.
                  </p>
                </div>
              </div>
              <div className="flex justify-center mt-8 mr-4 md:justify-end">
                <Link href="/contact">
                  <a className="flex items-center justify-center px-5 py-3 text-base font-medium text-white border border-transparent rounded-md bg-primary hover:bg-primary-dark">
                    Contact Us
                  </a>
                </Link>
              </div>
            ...
            <div className="relative pb-6 md:-mr-4 md:border-l md:pl-4 md:order-2 md:col-span-3 md:py-6 border-neutral-100">
              <blockquote className="w-full py-4 -mx-2 text-lg font-bold text-center text-red-700 break-normal border-y md:border-t-0 md:pt-0 border-neutral-100">
                DO NOT SEND YOUR CALIBRATION GAS TO PID ANALYZERS, LLC.
                UNDECLARED HAZARDOUS MATERIALS WILL RESULT IN FINES FROM THE
        ...
        <div className="relative py-6 shadow-inner md:py-12 bg-neutral-200">
          <div className="lg:mx-auto lg:max-w-7xl lg:grid lg:grid-cols-12 gap-x-20">
            <div className="col-span-8 px-8 prose prose-lg border-r border-neutral-300">
              ...
              <p>
                ...
                <Link
                  href="/contact"
                  className="text-red-600 hover:text-red-600-dark"
                >
                  sales@hnu.com
                </Link>{' '}
              ...
              <p className="mt-4">
                ...
                operation of our 101s. For a comphrensive manual, you will need
                to purchase the manual from us.
              </p>
              <p className="mt-4">
            ...
            <div className="col-span-4 pl-4 mt-4 md:mt-0">
              <h3 className="py-2 font-semibold leading-6 tracking-wide uppercase text-neutral-700">
                Manuals
              </h3>
              <ul className="pl-2">
