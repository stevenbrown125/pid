    ...
    <div className="grid items-center justify-center grid-cols-1 text-center lg:grid-cols-4 md:grid-cols-2 justify-items-center">
      {products.map((product: IProduct) => (
        ...
        >
          <div
            key={product.id}
            className="relative flex flex-col h-full border border-neutral-200 md:border-none sm:rounded-lg group"
          >
            ...
            <div className="absolute bottom-0 w-full p-4 bg-red-700 group-hover:visible rounded-b-md">
